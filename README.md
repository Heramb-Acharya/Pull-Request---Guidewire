...
**Phase 1 — Foundation** *(Weeks 1–2, due March 20)*
- [x] Persona definition and scenario mapping
- [x] Parametric trigger design with thresholds
- [x] Weekly premium model architecture
- [x] Fraud detection system design
- [ ] GitHub repository + README
- [ ] Basic project scaffolding (React + FastAPI)

**Phase 2 — Core Platform** *(Weeks 3–4, due April 4)*
- [ ] Worker registration + KYC flow
- [ ] Policy creation with AI premium calculation
- [ ] Parametric trigger engine (5 triggers)
- [ ] Mock API integrations (weather, AQI, news)
- [ ] Claims management module
- [ ] Fraud detection module (Isolation Forest)
- [ ] 2-minute demo video

**Phase 3 — Scale & Polish** *(Weeks 5–6, due April 17)*
- [ ] Advanced fraud detection (GPS spoofing, coordination)
...
|---|---|---|
| Phase 1 | March 20, 2026 | This README + GitHub repo + 2-min video |
| Phase 2 | April 4, 2026 | Working platform: registration, policy, claims, dynamic pricing |
| Phase 3 | April 17, 2026 | Fraud detection, payout simulation, dashboards, pitch deck, 5-min video |

---

## About GigShield

GigShield is built for Q-Commerce delivery partners across India who have no income safety net against weather, environmental, and civic events entirely outside their control. We start with Chennai — one of India's most disruption-prone cities — and build a model that can scale to every Q-Commerce zone in the country.

**Coverage scope**: Lost income only. No health. No vehicles. No accidents.

**Pricing model**: Weekly, always. ₹49–99/week. Aligned with how gig workers earn.

**Claim process**: Zero-touch. Fully automated. Triggered by verified external data.
